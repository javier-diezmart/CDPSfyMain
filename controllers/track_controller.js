...
exports.create = function (req, res) {
	var urlPOST = 'http://www.tracks.cdpsfy.es/api/tracks';
	...
	request.post({url: urlPOST, formData: formData}, function optionalCallback(err, httpResponse,body){
		if(err){return console.error('fallo al hacer el post: ', err);
			...
			var nuevaUrl = 'http://www.tracks.cdpsfy.es/api/tracks/'+body;
...
exports.destroy = function (req, res) {
	...
	var URLservidor = 'http://www.tracks.cdpsfy.es/api/tracks/'+trackId;
	var request= require('request');
